...
RSpec.describe Enrollment, type: :model do
  context "it works!" do
    it "creates enrollment and bills" do
      ...
      enrollment = Enrollment.create(student_id: student.id, installments: 5, amount: 1200000, due_day: 5)
  ...
  context "params missing" do 
    it "student_id missing" do
      enrollment = Enrollment.create(student_id: nil, installments: 5, amount: 1200000, due_day: 5)
